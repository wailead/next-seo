  ...
  return (
    <BannerLayout>
      <div className="flex py-[4vw] primary:py-[2rem] mobile:flex-row flex-col mobile:gap-6 gap-1 w-full items-center justify-center">
        <div>
          <p className="mobile:text-[2.65vw] text-[20px] primary:text-[20px]">문화체육관광부 한국관광공사 주관</p>
          <h1 className="mobile:text-[2.65vw] text-[20px] primary:text-[20px]">올해의 관광벤처 우수기업 선정</h1>
        </div>
