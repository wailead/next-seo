...
function PerformanceBox({ title, count, unit, className }: PerformanceBoxProps) {
  return (
    <article
      ...
      <h2 className="font-pretendard font-normal primary:text-[0.91rem] mobile:text-[1.94vw] text-[4.44vw] primary:leading-[1.365rem] mobile:leading-[2.92vw] leading-[6.67vw] tracking-[-0.005rem] text-gray-300">
        {title}
      </h2>
