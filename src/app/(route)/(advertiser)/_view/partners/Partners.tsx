        ...
        <TitleForm subtitle="REVIEW" title={`400개의 업체와 마케팅을\n함께하고 있습니다`} pb="pb-0">
          <div className="flex flex-col primary:gap-[1.5rem] mobile:gap-[3.15vw] gap-[4vw] ">
            <div className="flex  mobile:flex-row flex-col primary:gap-[1.5rem] mobile:gap-[3.15vw] gap-[4vw]">
              {/* 첫 번째 카드 레이아웃 */}
              <div className="primary:w-[24rem] mobile:w-[50.4vw] w-[83.8vw] primary:h-[23.27rem] mobile:h-[48.867vw] h-[52.2vw] bg-[url('/assets/images/review_img_0.png')] bg-cover mobile:rounded-[1rem] rounded-[7vw] primary:pb-[2.1rem] mobile:pb-[3.822vw] pb-[3vw]  mobile:pt-[5vw] pt-[5vw] primary:px-[1.82rem] mobile:px-[3.822vw] px-[5vw] flex justify-center items-end">
              ...
              <div className="flex flex-col primary:gap-[1.5rem] mobile:gap-[3.15vw] gap-[4vw]">
                {/* 두 번째 카드 레이아웃 */}
                <div className="flex flex-col primary:gap-[0.25rem] mobile:gap-[0.525vw] gap-[0.924vw] primary:w-[15.6rem] mobile:w-[32.76vw] w-[83.8vw] primary:h-[11rem] mobile:h-[23.1vw] h-[52.2vw] bg-[url('/assets/images/review_img_1.png')] bg-cover mobile:rounded-[1rem] rounded-[7vw] primary:pb-[1.04rem] mobile:pb-[2.18vw] pb-[3vw] primary:px-[1.04rem] mobile:px-[2.18vw] px-[5vw]  justify-end">
                  <p className="font-pretendard font-bold primary:text-[1.1rem] mobile:text-[1.9vw] text-[3.4vw] text-white-default">
                    이비스 스타일 앰배서더
                  </p>
                ...
                {/* 세 번째 카드 레이아웃 */}
                <div className="flex flex-col primary:gap-[0.25rem] mobile:gap-[0.525vw] gap-[0.924vw] primary:w-[15.6rem] mobile:w-[32.76vw] h- primary:h-[11rem] mobile:h-[23.1vw] h-[52.2vw] bg-[url('/assets/images/review_img_2.png')] bg-cover mobile:rounded-[1rem] rounded-[7vw] primary:pb-[1.04rem] mobile:pb-[2.18vw] pb-[3vw] primary:px-[1.04rem] mobile:px-[2.18vw] px-[5vw]  justify-end">
                  <p className="font-pretendard font-bold primary:text-[1.1rem] mobile:text-[1.9vw] text-[3.4vw] text-white-default">
                    그랩디오션
                  </p>
                  <p className="primary:text-[1.1rem] mobile:text-[1.9vw] text-[3.4vw] text-white-default">
            ...
            <div>
              <object
                ...
                className="relative primary:w-[41.1srem] mobile:w-[86.31.4vw] w-[83.8vw] primary:h-[23.27rem] mobile:h-[48.867vw] h-[52.2vw] mobile:rounded-[1rem] rounded-[7vw]"></object>
            </div>
          </div>
        </TitleForm>
      </div>
