      ...
      <TitleForm title="와이리 인플루언서가 되어야 하는 이유!" subtitle="INTRODUCTION">
        <div className="flex flex-col gap-[12.48px]">
          ...
          <IntroductionBox
            ...
            <div className="absolute bottom-0 right-0">
              <Image
                ...
                width={styleRatio(384)}
                height={styleRatio(384)}
              />
            </div>
          </IntroductionBox>
          <IntroductionBox
            className="bg-primary-200 relative pb-[59.8px]"
          ...
          <IntroductionBox
            ...
            <p className="font-pretendard font-light text-gray-100 pl-[41.6px]">
