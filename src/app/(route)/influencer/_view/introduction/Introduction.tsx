    ...
    <SectionLayout>
      <TitleForm title="와이리 인플루언서가 되어야 하는 이유!" subtitle="INTRODUCTION">
        <div className="flex flex-col gap-[1.04vw] w-full">
          ...
          <IntroductionBox
            className="bg-primary-200 relative pb-[4.98vw] -z-10"
          ...
          <IntroductionBox
            ...
            <div className="flex items-end justify-center gap-[2.125rem]">
              <div className="relative w-[6rem] h-[9rem]">
                <Image
              ...
              <div className="relative w-[6rem] h-[10rem]">
                <Image
              ...
              <div className="relative w-[6rem] h-[11rem]">
                <Image
