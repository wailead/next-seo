    ...
    <div
      ...
      <div
        ...
        <div className="flex flex-col w-full items-center">
          <div className="flex w-full justify-end">
            <button onClick={handleModal}>
              <CustomImage src={'/assets/images/close.svg'} alt="close" w="w-[1.469rem]" h="h-[0.092rem]" />
            </button>
          </div>
          <div className="flex flex-col w-[16.25rem] top-0 items-center gap-2.5">
            ...
            <CustomImage src={'/assets/images/polygon.png'} alt="polygon" w="w-[0.5rem]" h="h-[0.031rem]" />
          </div>
        </div>
        <div className="flex gap-[0.625rem]">
          <div className="flex flex-col w-fit gap-3 pl-6">
            <div className="flex gap-[0.875rem] pt-[3.625rem]">
              <div className="flex flex-col bg-white-default p-[0.869rem] justify-center items-center gap-[0.625rem] rounded-2xl shadow-[0_4px_10px_-3px_rgba(0,0,0,0.4)]">
                <CustomImage src="/images/qr_appstore.png" alt="appleQR" w="w-[11rem]" h="h-[0.688rem]" />
                <div className="flex items-center gap-[0.438rem]">
                  <CustomImage src={'/images/gray_apple.svg'} alt="applelogo" w="w-[1.5rem]" h="h-[0.094rem]" />
              ...
              <div className="flex flex-col bg-white-default p-[0.881rem] justify-center items-center gap-[0.625rem] rounded-2xl shadow-[0_4px_10px_-3px_rgba(0,0,0,0.4)]">
                <CustomImage src="/images/qr_playstore.png" alt="googleQR" w="w-[11rem]" h="h-[0.688rem]" />
                <div className="flex items-center gap-[0.438rem]">
                  <CustomImage src={'/images/gray_google.svg'} alt="applelogo" w="w-[1.563rem]" h="h-[0.098rem]" />
          ...
          <CustomImage src={'/assets/images/modal_phone.png'} alt="phone" w="w-[14.688rem]" h="h-[0.918rem]" />
        </div>
      </div>
    </div>
  )
