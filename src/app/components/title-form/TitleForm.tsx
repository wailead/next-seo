...
function TitleForm({ subtitle, title, children, pb = 'pb-bottom', pr, titleColor, subTitleColor }: titleFormProps) {
  return (
    <div className={twMerge(`px-x pt-top ${pb} flex flex-col gap-[1.82rem]`, pr)}>
